...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh-cn.search-data.min.32348fc1850e26ff7dc4eb72be6d9cdee82c09d73065e658479fb72d20e2d30f.js',function(){input.required=false;search();});}
