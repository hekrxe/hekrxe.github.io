...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh-cn.search-data.min.70249f23bebac202e7169527d6efc17d99ebcaa5aadcde443a31944ae6b296a5.js',function(){input.required=false;search();});}
