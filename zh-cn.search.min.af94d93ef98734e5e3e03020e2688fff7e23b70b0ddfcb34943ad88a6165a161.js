...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh-cn.search-data.min.1aee6db327468aa020bc2d1b6aff645228dc9a5a05abef259c6feefb6a7a4db0.js',function(){input.required=false;search();});}
